...
% M_T study plots taken from AN-16-463. Unpublished.
% Also, they still say "Preliminary" on them...
\begin{figure}[htb]
\centering
...
% N-1 plots, made by moi, but sourced from AN-16-463. Unpublished.
% Still say "Preliminary". And signal points are all DM=150. And
% x-axis for MinDPhi could be better labeled.
\begin{figure}[htb]
\centering
...
% bulk results scraped from tables in AN-16-463. Unpublished.
\begin{sidewaystable}
\centering
\scriptsize
...
% bulk numbers scraped from tables in AN-16-463. Unpublished.
\begin{sidewaystable}
\centering
\small
