...
\cite{cdfchargeasym1,cdfchargeasym2,d0chargeasym1,d0chargeasym2}, and % Use natbib to sort the references by mention order, not alphabetically
...
\item We evaluate the efficiencies of our chosen triggers,
  ...
  MC events to reflect these efficiencies. % Do I need to describe efficiency measurements in detail?
...
% For one thing, they still say "CMS Preliminary"
\begin{figure}[phtb]
  \centering
...
% Consider adding: Jet pT

\begin{figure}[phtb]
  \centering
  \includegraphics[width=0.45\textwidth]{figures/dataMC_lep_azimuthal_asymmetry2_combined.pdf}
  \includegraphics[width=0.45\textwidth]{figures/dataMC_lep_costheta_combined} % Unofficial plot, not from the AN!
...
the context of our asymmetry measurements, the technique is used as follows: %%%% Where do the citations go? Maybe here?
