...
to these effects are discussed below. In Section
\ref{ssec:afb:regsyst}, we will give special consideration to the
uncertainty due to regularization.
...
\item \textbf{Factorization and renormalization scales:} We evaluate
  the uncertainty by substituting MC@NLO $\ttbar$ samples that have
...
\subsection{Regularization Systematic}
\label{ssec:afb:regsyst}
...
% Probably not, since I don't give hard numbers for the tau variation either.
